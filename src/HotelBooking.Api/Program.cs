...
// Swagger is enabled in all environments (including the Docker/Production demo image)
// so this portfolio project is easy to explore without a separate dev setup.
app.UseSwagger();
app.UseSwaggerUI();
